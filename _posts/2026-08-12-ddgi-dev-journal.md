...
By leveraging Vulkan’s acceleration structures and ray query shader functions, I can get a clean representation of light visibility from any point in the scene. Image on the left shows AABB overlap. Image on the right is a traversal timing heatmap. Heavily overlapping AABBs result in moderately costly traversals, as seen in the curtains and pillars on the lower level. Non-opaque, in this case, alpha masked primitives are the most costly to traverse. Both views are captured with NSight Graphics.
